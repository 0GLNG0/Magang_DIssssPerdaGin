               ...
               <div class="row right-side mx-0">
                    ...
                    <div class="col" id="btn-find">
                         <form class="d-flex bg-light f-search rounded my-2" role="search">
                              ...
                              <button class="btn border-0 bg-white py-0 px-2" type="submit"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26"
                                        fill="none">
                                        <g clip-path="url(#clip0_705_3966)">
                                             <path d="M11.375 19.5C15.8623 19.5 19.5 15.8623 19.5 11.375C19.5 6.88769 15.8623 3.25 11.375 3.25C6.88769 3.25 3.25 6.88769 3.25 11.375C3.25 15.8623 6.88769 19.5 11.375 19.5Z"
                         ...
                         <div class="collapse navbar-collapse" id="navbarNav">
                              <ul class="navbar-nav">
                                                       ...
                                                       <a href="https://www.instagram.com/disperdagin_kotakediri?igsh=ZDhvNmF0NXlpempr"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="25"
                                                                 ...
                                                                 <g clip-path="url(#clip0_705_3958)">
                                                                      <path d="M12.5 16.9062C14.6574 16.9062 16.4062 15.1574 16.4062 13C16.4062 10.8426 14.6574 9.09375 12.5 9.09375C10.3426 9.09375 8.59375 10.8426 8.59375 13C8.59375 15.1574 10.3426 16.9062 12.5 16.9062Z"
                                                                           stroke="#07374E" stroke-width="2"
                                                                           stroke-miterlimit="10" />
                                                                      <path d="M17.1875 3.625H7.8125C5.22367 3.625 3.125 5.72367 3.125 8.3125V17.6875C3.125 20.2763 5.22367 22.375 7.8125 22.375H17.1875C19.7763 22.375 21.875 20.2763 21.875 17.6875V8.3125C21.875 5.72367 19.7763 3.625 17.1875 3.625Z"
                                                                           stroke="#07374E" stroke-width="2"
                                                                           stroke-linecap="round"
                                                                           stroke-linejoin="round" />
                                                                      <path d="M17.5781 9.09375C18.2253 9.09375 18.75 8.56908 18.75 7.92188C18.75 7.27467 18.2253 6.75 17.5781 6.75C16.9309 6.75 16.4062 7.27467 16.4062 7.92188C16.4062 8.56908 16.9309 9.09375 17.5781 9.09375Z"
                                                                           fill="#07374E" />
                                                                 </g>
                                                                 <defs>
                                   ...
                                   <div class="fa fa-comment fa-3x">
                                        <i class="fa fa-comment" aria-hidden="true" data-bs-toggle="modal"
                    ...
                    <div class="col-lg-12 col-12">
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   ...
                                   <img src="images/project/project-detail/woman-shopping-organic-vegetables-fruits_1150-17779.avif"
                              ...
                              <div class="item project-wrapper" data-aos="fade-up">
                                   <img src="images/project/project-detail/aset_carousel.jpg" class=""
                                        alt="project image">
...
WHERE rn = 1 AND nama_barang IN ('Beras premium', 'Beras Medium', 'Telur Ayam ras', 'Cabe Merah Keriting', 'Cabe Merah Besar','Gula Kristal Putih','Minyak Goreng Curah','Daging Sapi Paha Belakang','Bawang Merah','Bawang Putih Sinco/Honan');"
               ?>
          <div class="container-xxl">
               <div class="row row-cols-3 row-cols-lg-5 g-2 g-lg-5 d-flex justify-content-center" data-aos="fade-up">
