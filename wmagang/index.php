...
<body>
                    ...
                    <div class="col-lg-12 col-12">
                         ...
                         <div class="owl-carousel owl-theme" id="project-slide">
                              <div class="item project-wrapper" data-aos="fade-up" data-aos-delay="100">
                                   ...
                                   <img src="images/project/project-detail/woman-shopping-organic-vegetables-fruits_1150-17779.avif" class=" w-100" alt="project image">
     ...
     <section class=" d-flex justify-content-center align-items-center" data-aos="fade-up">
          <div class="container text-center">
               <div class="row row-cols-2 row-cols-lg-5 g-2 g-lg-3">
                    <div class="col">
                         <div class="card shadow shadow-sm rounded-top border-0">
                              <a href="">
                                   <img src="images/lpicon.png" class="img-thumbnail border-0" alt="">
                              </a>
          ...
          <div class="container text-center">
               <div class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                    <div class="col">
                         ...
                         <div class="card-title rounded-bottom shadow">
                              <p>lorem ipsum</p>
                         </div>
                    </div>
                    <div class="col">
