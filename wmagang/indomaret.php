    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          ...
          <ul class="isi-dropdown">
            <li><a href="https://banmod.indagkediri.online" target="_blank">Bantuan Modal</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-7 col-12">
          <h1> <strong class="gradient-text" data-aos="fade-up" data-aos-delay="100">Lokasi Indomaret Kota
              Kediri</strong></h1>

          <div class="quote" data-aos="fade-up" data-aos-delay="200"></div>

          <h3 class="mb-4" data-aos="fade-up" data-aos-delay="300">Klik Menu dibawah untuk Menampilkan Lokasi</h3>
        </div>
      </div>
      <a onclick="show('mojoroto')" class="custom-bttn bttn-bg btn mt-3" data-aos="fade-up"
        data-aos-delay="300">Mojoroto</a>
      <a onclick="show('pesantren')" class="custom-bttn bttn-bg btn mt-3" data-aos="fade-up"
        data-aos-delay="300">Pesantren</a>
      <a onclick="show('kota')" class="custom-bttn bttn-bg btn mt-3" data-aos="fade-up" data-aos-delay="300">Kota</a>
      <!--Kecamatan Mojoroto-->
      <div id="mojoroto">
        <script>
          function dummy() { }
      ...
      <div id="pesantren">
        ...
        <div id="mappesantren"></div>
        <script>
          function initMappesantren() {
            // Inisialisasi peta dengan lokasi awal yang ditentukan
            var initialLocation1 = { lat: -7.829347670572409, lng: 112.02491041750754 };
            var mappesantren = new google.maps.Map(document.getElementById("mappesantren"), {
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr>
              <th scope="row">2</th>
              <td>Indomaret Mauni Kediri</td>
              <td>Jl. Mauni</td>
              <td>Bangsal</td>
            </tr>
            <tr>
              <th scope="row">3</th>
              <td>Indomaret Pesantren</td>
              <td>Jl. Mauni No. 88</td>
              <td>Pesantren</td>
            </tr>
            <tr>
              <th scope="row">4</th>
              <td>Indomaret Letjend Sutoyo Kediri</td>
              <td>Jl. Letjend Sutoyo</td>
              <td>Bangsal</td>
            </tr>
          </tbody>
        </table>
      ...
      <div id="kota">
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            <tr>
              <th scope="row">1</th>
              <td>Indomaret Ngronggo</td>
              <td>Jl. Kapten Tendean No. 198</td>
              <td>Ngronggo</td>
            </tr>
            <tr>
              <th scope="row">2</th>
              <td>Indomaret Doko Indah</td>
              <td>Jl. Ir. Sutami</td>
              <td>Banjaran</td>
            </tr>
            <tr>
              <th scope="row">3</th>
              <td>Indomaret Selowareh</td>
              <td>Jl. Selowareh</td>
              <td>Ngadirejo</td>
            </tr>
            <tr>
              <th scope="row">4</th>
              <td>Indomaret Joyoboyo</td>
              <td>Kemasan</td>
              <td>Kemasan</td>
            </tr>
            <tr>
              <th scope="row">5</th>
              <td>Indomaret Sersan Suharmaji</td>
              <td>Jl. Sersan Suharmaji No. 29</td>
              <td>Manisrenggo</td>
            </tr>
          </tbody>
        </table>
